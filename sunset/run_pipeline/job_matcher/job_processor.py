...
class JobProcessor:
    """Beautiful, modular job processor with consciousness-first evaluation"""
    
    def __init__(self, num_runs: int = 5, use_consciousness: bool = True):
        self.num_runs = num_runs
        self.use_consciousness = use_consciousness
        self.data_loader = JobDataLoader()
        self.llm_evaluator = LLMEvaluator(num_runs=num_runs, use_consciousness=use_consciousness)
