#!/usr/bin/env python3
"""
Default prompt for job matching.

This module contains the default prompt template for job matching 
that will be used as a fallback when the prompt cannot be loaded from the prompt manager.
"""

# Default prompt template (from the original hardcoded prompt)
...
- **Low match:** if ANY of these conditions apply: THIS RULE IS ALWAYS VALID!
